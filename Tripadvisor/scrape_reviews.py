    ...
    request = [
      {
        "variables": {
          "interaction": {
            "productInteraction": {
              ...
              "pageview": {
                "pageview_request_uid": "70cbc6a4-6170-40d2-b3dd-5182226a36ba",
                "pageview_attributes": {
                  "location_id": loc,
                  "geo_id": geo,
              ...
              "user": {
                ...
                "site_persistent_user_uid": "web332a.138.246.3.57.189DE7AB6CA",
                "unique_user_identifiers": {
                  "session_id": "C9F5A95486494D498DFB9273026A9B8E"
                }
              },
              "search": {},
              "item_group": {
                "item_group_collection_key": "70cbc6a4-6170-40d2-b3dd-5182226a36ba"
              },
              "item": {
                "product_type": "Hotels",
        ...
        "extensions": {
          "preRegisteredQueryId": "0eb3cf00f96dd65239a88a6e12769ae1"
        }
      },
      {
        "variables": {
          "key": "locationReviewFilters_241729",
          "val": [{"axis": "LANGUAGE", "selections": [lang]}]
        },
        "query": "05ee4484c857bedd3a8bb64a1642744c",
        "extensions": {
          "preRegisteredQueryId": "05ee4484c857bedd3a8bb64a1642744c"
        }
      },
      {
        "variables": {
        ...
        "extensions": {
          "preRegisteredQueryId": "ea9aad8c98a6b21ee6d510fb765a6522"
        }
      }
    ]
    headers = {
