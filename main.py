...
BASE_URL = 'https://www.tripadvisor.com/Restaurants-g187791-Rome_Lazio.html'
PER_PAGE = 30
...
def get_number_of_pages(BASE_URL, PER_PAGE):
    try:
        ...
        span_element = driver.find_element(By.XPATH, "//span[contains(text(), ' results match your filter')]")
        ...
        total_results = int(result_parts[0])
...
def get_link(url):
    try:
        ...
        pattern = r'Restaurant_Review.*?\.html'
        results = []
...
with open("links_rom.csv", mode='a+', newline='') as file:
